...
| 力输入 | `/jaka_fts_broadcaster/wrench` | `geometry_msgs/msg/WrenchStamped` | F/T broadcaster 或仿真 FTS |
| 环境输入 | `/scan` | `sensor_msgs/msg/LaserScan` | Lakibeam 或仿真 LiDAR |
| 底盘输出 | `/cmd_vel` | `geometry_msgs/msg/Twist` | MRT，唯一发布者 |
| 机械臂输出 | `/jaka_forward_controller/commands` | `std_msgs/msg/Float64MultiArray` | MRT，唯一发布者 |
...
```text
src/tracer_jaka/jaka_ros2/src/tracer_driver/tracer_ros2/tracer_base
```
...
当前 launch/节点中仍存在 `/home/a/ocs2_ws/...` 和 `/home/a/workspaces/...` 绝对路径。所有部署资源应通过：
