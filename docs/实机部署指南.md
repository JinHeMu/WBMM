...
| 实机 OCS2 启动雏形 | `src/algorithms/control/tracer_jaka_ocs2/launch/ocs2_real.launch.py` | 启动底盘、JAKA 控制器、MPC/MRT |
| 实机定位 | `src/simulation/tracer_jaka_mujoco/launch/real_slam.launch.py` | Tracer + IMU + Lakibeam + EKF + SLAM |
