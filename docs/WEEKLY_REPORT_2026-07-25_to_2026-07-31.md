...
- `src/bringup/tracer_jaka_bringup/maps/factory_map.yaml` + `factory_map.pgm`
...
| 模块 | 代码位置 |
|---|---|
| REMANI FSM | `src/vendor/remani_planner/plan_manage/src/remani_replan_fsm.cpp` |
| Planner Manager | `src/vendor/remani_planner/plan_manage/src/planner_manager.cpp` |
| Hybrid A* | `src/vendor/remani_planner/path_searching/src/kino_astar.cpp` |
| 机械臂 RRT | `src/vendor/remani_planner/path_searching/src/sample_mani_RRT.cpp` |
| MINCO/L-BFGS 优化 | `src/vendor/remani_planner/traj_opt/src/poly_traj_optimizer.cpp` |
| GridMap/ESDF | `src/vendor/remani_planner/plan_env/src/grid_map.cpp` |
| 机器人碰撞模型 | `src/vendor/remani_planner/mm_config/src/mm_config.cpp` |
| REMANI→OCS2 Bridge | `src/algorithms/control/tracer_jaka_ocs2/src/remani_to_ocs2_reference_bridge.cpp` |
| OCS2 MPC | `src/algorithms/control/tracer_jaka_ocs2/src/TracerJakaMpcNode.cpp` |
| OCS2 MRT | `src/algorithms/control/tracer_jaka_ocs2/src/TracerJakaMrtNode.cpp` |
| MuJoCo Bridge | `src/simulation/tracer_jaka_mujoco/tracer_jaka_mujoco/mujoco_bridge_node.py` |
| 实机 SLAM Launch | `src/simulation/tracer_jaka_mujoco/launch/real_slam.launch.py` |
| D455 rosbag 录制 | `src/simulation/tracer_jaka_mujoco/launch/record_d455_esdf_bag.launch.py` |
