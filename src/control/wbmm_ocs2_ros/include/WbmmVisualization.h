...
//
//  发布话题 (默认):
//    /wbmm/optimizedStateTrajectory   visualization_msgs/MarkerArray
//    /wbmm/optimizedPoseTrajectory    geometry_msgs/PoseArray
//    /wbmm/referenceTrajectory        visualization_msgs/MarkerArray
//    /wbmm/environmentObstacles       visualization_msgs/MarkerArray  (静态, 发一次)
...
namespace wbmm
{
    ...
    private:
        ...
        wbmm_ocs2::WbmmModelInfo modelInfo_;
