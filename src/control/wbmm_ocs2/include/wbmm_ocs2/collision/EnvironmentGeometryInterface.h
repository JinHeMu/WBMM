...
public:
    ...
    /**
     * @brief Constructor - reuses existing ocs2::PinocchioGeometryInterface
     ...
     */
    EnvironmentGeometryInterface(const ocs2::PinocchioGeometryInterface& pinocchioGeomInterface,
...
private:
     ...
     */
    void filterRobotGeometries(const ocs2::PinocchioInterface& pinocchioInterface,
                                const std::vector<std::string>& robotCollisionLinks);
