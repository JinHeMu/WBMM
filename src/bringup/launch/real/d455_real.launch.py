#!/usr/bin/env python3
"""Start the base-mounted RealSense D455 with URDF-compatible frames."""
...
def generate_launch_description():
    """Publish D455 RGB-D streams rooted at the URDF's d455_link."""
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                # camera_name=d455 + base_frame_id=link => d455_link.
                "base_frame_id": "link",
                "enable_color": "true",
                "enable_depth": "true",
                "enable_sync": "true",
