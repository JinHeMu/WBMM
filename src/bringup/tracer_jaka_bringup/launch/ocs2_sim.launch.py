...
def generate_launch_description():
    ...
    declare_args = [
        ...
        # MuJoCo world and published odometry now share the same origin.
        DeclareLaunchArgument(
            "remani_static_esdf_offset_x",
            default_value="0.0",
        ),
        ...
        DeclareLaunchArgument(
            "init_keyframe",
            default_value="home",
            description="MuJoCo keyframe used to initialize the robot.",
        ),
        DeclareLaunchArgument(
            "map_to_odom_x",
            default_value="0.0",
        ...
        DeclareLaunchArgument(
            ...
            default_value="0.10",
            description=(
                "Clearance outside REMANI's physical URDF arm spheres."),
        ),
        DeclareLaunchArgument(
            "remani_general_safe_margin",
            default_value="0.10",
            description="Clearance outside REMANI physical base spheres.",
        ),
        DeclareLaunchArgument(
            "remani_self_safe_margin",
            default_value="0.10",
            description="Clearance between REMANI robot spheres.",
        ),
        DeclareLaunchArgument(
            "remani_freeze_manipulator",
            default_value="false",
        ...
        DeclareLaunchArgument(
            ...
            default_value="0.40",
            description=(
                "Large final base error required for REMANI replanning; "
                "smaller residuals remain with MPC."),
        ),
        DeclareLaunchArgument(
            "remani_goal_replan_yaw_threshold",
            default_value="0.70",
        ...
        DeclareLaunchArgument(
            ...
            default_value="20",
            description=(
                "Consecutive REMANI search failures before abandoning the "
    ...
    ekf_node = Node(
        ...
        output="screen",
        parameters=[
            PathJoinSubstitution([pkg_bringup, "config", "ekf_sim.yaml"]),
    ...
    remani_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "manipulator_safe_margin": remani_manipulator_safe_margin,
            "general_safe_margin": remani_general_safe_margin,
            "self_safe_margin": remani_self_safe_margin,
