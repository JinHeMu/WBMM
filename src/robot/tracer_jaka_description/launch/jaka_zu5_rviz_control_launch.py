...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'robot_description',
            default_value=FindPackageShare('tracer_jaka_description') + '/urdf/jaka_zu5.urdf',
        ...
        Node(
            ...
            executable='rviz2',
            name='rviz',
            arguments=['-d', FindPackageShare('tracer_jaka_description') + '/config/jaka_zu5_urdf.rviz'],
            required=True
        ),
    ])
