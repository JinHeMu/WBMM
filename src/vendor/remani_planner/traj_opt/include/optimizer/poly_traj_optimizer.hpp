...
namespace remani_planner
{
  ...
  private:
    ...
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr traj_pt_pub_, traj_init_pt_pub_;
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr front_end_mm_mesh_vis_pub_, back_end_mm_mesh_vis_pub_;
  public:
    ...
    /* set variables */
    void setParam(const rclcpp::Node::SharedPtr &node, const std::shared_ptr<GridMap> &map, const std::shared_ptr<MMConfig> &mm_config);
