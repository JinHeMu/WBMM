...
namespace remani_planner
{
  ...
  private:
    ...
    int max_consecutive_planning_failures_;
    int last_end_id_;
    ...
    double tracking_goal_replan_position_threshold_;
    double tracking_goal_replan_yaw_threshold_;
    double tracking_goal_replan_joint_threshold_;
    double tracking_goal_replan_persistence_;
    double tracking_error_since_sec_;
    double goal_error_since_sec_;
    ...
    void abandonCurrentGoal(const std::string & reason);
